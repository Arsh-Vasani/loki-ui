...
export function HeroSection() {
  return (
    <section className="space-y-12 fade-in-up fade-in-delay-1">
      {/* Hot pill */}
      <div className="inline-flex items-center gap-2 rounded-full border border-slate-800 bg-slate-900/80 px-5 py-2 text-sm font-medium text-slate-200">
      ...
      <div className="space-y-6 max-w-4xl">
        ...
        <p className="text-balance text-lg text-slate-300 sm:text-xl leading-relaxed max-w-3xl">
      ...
      <div className="flex flex-wrap items-center gap-4">
        <a
          href="#components"
          className="group inline-flex items-center gap-2 rounded-full bg-slate-50 px-8 py-4 text-base font-semibold text-slate-950 shadow-[0_0_28px_rgba(15,23,42,0.9)] transition hover:bg-slate-200"
        >
          Browse Components
